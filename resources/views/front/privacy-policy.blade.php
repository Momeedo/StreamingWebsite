...
@section('title')
Privacy Policy - nfoot.net, The Live Sports Channels Streaming Platform!
@endsection
@section('meta')
<meta property="og:title" content="Privacy Policy - nfoot.net, The Live Sports Channels Streaming Platform!">
...
<meta name="twitter:title" content="Privacy Policy - nfoot.net, The Live Sports Channels Streaming Platform!">
...
<section class="vds-main">
	<div class="container">
		<div class="vidz_sec">
			<span class="page-title"><i class="fas fa-user-lock"></i> Privacy Policy</span>
			<div class="vidz_list">
				<div class="row">
