		...
		<div class="row">
			<div class="col-lg-9">
				<div class="mn-vid-sc single_video">
					<div class="vid-1">
						<div class="vid-info">
							<h3>BeIN Sports HD 1 (French)</h3>
							<div class="info-pr">
								<span><i class="fas fa-eye"></i> 60,723,169 views</span>
								<div class="form-separation"></div><div class="form-separation"></div>
								<span>Tags:&nbsp;&nbsp;</span><span style="color:#4a90e2;">#Live #BeIN #French</span>
					...
					<div class="info-pr-sec">
						<center><h3>Highlighted Games of the Day on this Channel<br><a class="h3-seeall" href="games.html">(See All)</a></h3></center>
