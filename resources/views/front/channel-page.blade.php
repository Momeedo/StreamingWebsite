        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="mn-vid-sc single_video">
                    ...
                    <div class="abt-mk">
                        <div class="info-pr-sec">
                            ...
                            <ul class="df-list">
                                ...
                                <li>
                                    <a href="{{ url('/contact') }}" target="_blank" data-toggle="tooltip" data-placement="top" title="Report Channel">
                                        <i class="icon-flag"></i>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="info-pr-sec">
                        <center>
                            <h3>Highlighted Games of the Day on this Channel<br><a class="h3-seeall" href="/#channels-list">(See All Channels)</a></h3>
                        </center>
                        <div class="form-separation"></div>
